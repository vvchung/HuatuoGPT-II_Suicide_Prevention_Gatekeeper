...
export const TRANSLATIONS: Record<Language, TranslationSet> = {
  ...
  'ja': {
    ...
    callPoliceNum: '119',
    mindfulness: '呼吸法',
    mindfulnessTitle: 'マインドフルネス呼吸 4-4-4',
  ...
  'ko': {
    ...
    callPoliceNum: '119',
    mindfulness: '호흡하기',
    mindfulnessTitle: '마음챙김 호흡 4-4-4',
  ...
  'vi': {
    ...
    callPoliceNum: '119',
    mindfulness: 'Thở',
    mindfulnessTitle: 'Hít thở chánh niệm 4-4-4',
  ...
  'id': {
    ...
    mindfulnessTitle: 'Pernapasan Sadar 4-4-4',
  ...
  'th': {
    ...
    mindfulnessTitle: 'การหายใจอย่างมีสติ 4-4-4',
  ...
  'hi': {
    ...
    mindfulnessTitle: 'माइंडफुल ब्रीदिंग 4-4-4',
